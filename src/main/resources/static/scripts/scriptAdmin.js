require(["esri/config", "esri/Map", "esri/views/MapView", "esri/widgets/Locate", "esri/widgets/Track", "esri/Graphic",
  ...
  "esri/rest/support/FeatureSet", "esri/layers/GraphicsLayer"], function(esriConfig, Map, MapView, Locate, Track,
    Graphic, Search, FeatureLayer, route, RouteParameters, FeatureSet, GraphicsLayer) {
...
// Show each direction
  ...
  setInterval(() => {
    console.log(window.data2Show['car1']);
    graphicsLayer.removeAll();
    const point = { //Create a point
      type: "point",
      longitude: window.data2Show['car1']['lon'],
      latitude: window.data2Show['car1']['lat']
    };
    ...
    const point2 = { //Create a point
      type: "point",
      longitude: window.data2Show['car2']['lon'],
      latitude: window.data2Show['car2']['lat']
    };
